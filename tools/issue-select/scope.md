...
your rubric rejects, and cannot sink one it accepts. -->
 ...
 I am a software engineer with professional experience in Java, Spring Boot, REST APIs, microservices, PostgreSQL, Kafka, Kubernetes, Docker, cloud systems, and distributed services. I am especially interested in backend APIs, event-driven systems, databases, reliability, security, testing, performance, and production troubleshooting.
 
 For future contributions, I would prefer projects related to financial services, banking, payments, financial data, fraud detection, risk systems, secure enterprise platforms, or AI and GenAI applications. I am also interested in issues involving automation, intelligent testing, developer tooling, and AI-assisted engineering workflows.
 
 For this unit, evaluate the predefined issues objectively using the rubric. Use this profile only to rank issues that pass the required checks; it must not override an issue's accept or reject verdict.
